        ...
        <footer className='footer'>
            <div>
                ...
                <div>
                    <h3>About Us</h3>
                    <span>
                        <strong style={{color: "#000000"}}><span style={{color: "#0B6623"}}>READERS</span>DELIGHT</strong> is a free website to search, preview and download books into your devices. <Link to="/about">read more...</Link>
                    </span>
                </div>
                <div>
                    <h3>Pages</h3>
                    <Link to="/donate"><FaGift /> Donate a Book</Link>
                    <Link to="/request"><FaBookOpenReader /> Request a Book</Link>
                    <Link to="/requests"><FaBook /> Book Requests</Link>
                </div>
                <div>
                    <h3>Help</h3>
                    <Link to="/contact"><FaPhone /> Contact Us</Link>
                    <Link to="/feedback"><FaComments /> Feedback</Link>
                    {admin && <Link to="/donations"><FaHeart style={{ marginBottom: "-2px" }} /> Donations</Link>}
                </div>
            </div>
            <div>
