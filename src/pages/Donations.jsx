...
export default function Donations() {
  ...
  const dataChoose = adminSearch
    ? data.filter(
        (book) =>
          book.id.toLowerCase().indexOf(adminSearch.toLowerCase()) !== -1 ||
          ...
          book.link.toLowerCase().indexOf(adminSearch.toLowerCase()) !== -1 ||
          book.size.toLowerCase().indexOf(adminSearch.toLowerCase()) !== -1 ||
          book.pages
            .toString()
            .toLowerCase()
      ...
      <div className="home-books">
        ...
        {loaded && donationsElement.length === 0 && !adminSearch && (
          <p className="home-no-books">
            There are currently no books to review
          </p>
        )}
        {loaded && donationsElement.length === 0 && adminSearch && (
          <p className="home-no-books">
