  ...
  function BookStatus({ dat }) {
    ...
    async function update() {
      try {
        ...
        const mail =
          bookStat === "Completed"
            ? await requestMail(newData.name, newData.title, newData.email)
            : "sent";
        if (mail === "sent") {
          ...
          if (send === true) {
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                setData((oldData) =>
                  oldData.map((data) => (data.id === dat.id ? newData : data))
                );
                setLoading(false);
              }, 2000);
            }, 1000);
                  ...
                  <tr>
                    <td
                      ...
                      style={{
                        height: "70px",
                        background:
                          "linear-gradient(to top right, #F4F6FF 0%, #FFF 100%)",
