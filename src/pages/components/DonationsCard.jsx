          ...
          <div className="book-card-options">
                ...
                {email && (
                  <span>
                    ...
                    <strong>
                      <a
                        className="mail"
                        href={`mailto: ${email}?subject=Donation of ${title} Reviewed&content=Thank you for your donation to ReadersDelight.`}
                      >
                        {email}
                      </a>
                    </strong>
            ...
            <span>
              <Link
                to={id}
                state={{
                  book: { title, courses, size, pages, link, author, id },
                }}
              >
                <FaPenToSquare /> Edit
              </Link>
