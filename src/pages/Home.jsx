...
export default function Home() {
  ...
  const recentElements = recentData
    .slice(0, recentShow)
    .map((dat) => (
      <BookCard
        key={dat.id + "recent"}
    ...
    <div className="home">
      {welcome && (
        <div className="welcome-info">
          ...
          <span>
            ...
            is your source for academic resources. As of today we have{" "}
            {bookCount} resources available for download. It is free and has no
            download limits. Enjoy it and don't forget to bookmark and share the
            love!
          </span>
        </div>
      )}
      ...
      <div className="home-book-section">
        ...
        {recentMore && (
          <LoadMoreBtn
            data={recentData}
            setShow={setRecentShow}
            setMore={setRecentMore}
          />
        )}
      </div>
    </div>
