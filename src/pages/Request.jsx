  ...
  function requestContent() {
    return (
      ...
      >
        ...
        >
          <a
            href="https://readersdelight.netlify.app/"
            target="_blank"
            rel="noreferrer"
            style={{
              display: "block",
          ...
          <p style={{ marginTop: "10px", height: "36px" }}>
            Your book request for <i>{request.booktitle}</i> to{" "}
            <strong>
              <span style={{ color: "#0B6623" }}>READERS</span>DELIGHT
            </strong>{" "}
            eLibrary was successful!
          </p>
          <p>
          ...
          <p style={{ marginTop: "10px" }}>
            ...
            database. Happy reading!
          </p>
          <p style={{ marginTop: "10px", marginBottom: "0" }}>Warm regards,</p>
          <p style={{ marginTop: "0" }}>
            <strong>Readers Delight Team.</strong>
          </p>
        </div>
      </div>
    );
        ...
        {request.booktitle !== "" && (
          <span className="btn-request">
            ...
            <RequestDownloader
              ...
              filename={`${request.booktitle} Request`}
              btnname={"Download"}
              className={"btn"}
            />
            <LiaTimesCircle
              ...
              style={{ color: "black" }}
              onClick={() => {
                setRequest({ name: "", booktitle: "", ticket: "" });
              }}
            />
          </span>
        )}
        ...
        <div>
          <div className="field">
            <textarea
              ...
              rows={3}
              name="message"
              placeholder="Message (Hint: Details about the Book)"
              maxLength={250}
              value={data.message}
            />
            <label>Message</label>
